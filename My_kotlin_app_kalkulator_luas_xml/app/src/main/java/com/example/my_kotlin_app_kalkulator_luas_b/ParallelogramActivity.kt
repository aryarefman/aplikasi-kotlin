...
data class ParallelogramResult(
    val base: Double,
    val height: Double,
    val area: Double
)
...
class ParallelogramActivity : AppCompatActivity() {
    ...
    private var currentResult: ParallelogramResult? = null
    ...
    private fun setupListeners() {
        ...
        clearBaseButton.setOnClickListener {
            ...
            clearBaseButton.visibility = View.GONE
        ...
        calculateButton.setOnClickListener { calculateParallelogramArea() }
    ...
    private fun updateUnitDisplay() {
        ...
        baseInput.hint = "contoh: 5, 8.9"
        heightInput.hint = "contoh: 7, 10.5"
    }

    private fun calculateParallelogramArea() {
        ...
        currentResult = ParallelogramResult(base, height, area)
    ...
    private fun displayResult(base: Double, height: Double, area: Double) {
        ...
        solutionResult.text = "Luas = alas × tinggi = $formattedBase × $formattedHeight"
    ...
    private fun copyResultToClipboard() {
        currentResult?.let { result ->
            ...
            val resultText = """
                ...
                Perhitungan: Luas = ${formatNumber(result.base)} × ${formatNumber(result.height)}
            """.trimIndent()

            clipboard.setPrimaryClip(ClipData.newPlainText("Hasil Jajar Genjang", resultText))
