...
class KiteActivity : AppCompatActivity() {
    ...
    private var currentResult: KiteResult? = null
    ...
    private fun setupListeners() {
        ...
        calculateButton.setOnClickListener { calculateKiteArea() }
    ...
    private fun calculateKiteArea() {
        ...
        currentResult = KiteResult(diagonal1, diagonal2, area)
    ...
    private fun copyResultToClipboard() {
        currentResult?.let { result ->
            ...
            clipboard.setPrimaryClip(ClipData.newPlainText("Hasil Layang-layang", resultText))
